...
EUI_NEO_C_API eui_neo_result eui_neo_begin_window_drag(eui_neo_engine* engine);
EUI_NEO_C_API eui_neo_result eui_neo_get_cursor_position(eui_neo_engine* engine, double* out_x, double* out_y);
EUI_NEO_C_API eui_neo_result eui_neo_center_window(eui_neo_engine* engine, int32_t width, int32_t height);
EUI_NEO_C_API eui_neo_result eui_neo_set_clipboard_text(eui_neo_engine* engine, const char* text_utf8);
EUI_NEO_C_API const char*    eui_neo_get_clipboard_text(eui_neo_engine* engine);
